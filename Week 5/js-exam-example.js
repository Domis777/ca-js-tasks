...
{
  cars.forEach(fuelType => console.log(fuelType.getFuelType()))
}
console.groupEnd();
...
{
  petrolCars = cars.filter(car => car.fuelTypes.includes('electric') && car.year > 2016)
